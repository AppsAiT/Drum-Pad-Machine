...
class DrumPadPageB extends StatefulWidget {
  const DrumPadPageB({super.key, required this.onFlip});
  final VoidCallback? onFlip;

  @override
  State<DrumPadPageB> createState() => _DrumPadPageBState();
}

class _DrumPadPageBState extends State<DrumPadPageB> {
